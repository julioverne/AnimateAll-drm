...
NSString *pref_lice = @"/var/mobile/Library/Preferences/it.mpow.licanimall.plist";



NSString *mountString = [NSString stringWithFormat:@"%@%@%@", [[NSString udid] substringToIndex:8], @"ILoveCrackers", [[NSString udid] substringFromIndex:13]];
...
printf("Respring!!!\n");
printf("\n");
printf("*** Keygen AnimateAll HD by julioverne ***\n");
printf("\n");
}